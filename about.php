<?php
// about.php
$page_title = 'About Warung Pumps | Reliable Water Pump Manufacturer in India';
...
<section class="hero about-hero">
  <div class="hero-content">
    <h1>The Warung Pumps Story</h1>
    <p>Reliable Pumping Solutions. Deep Roots. Clear Purpose.</p>
  </div>
</section>
...
<section class="section">
  <div class="container flex">
    <div>
      <h2>From One Workshop to Hundreds of Farms</h2>
      <p>
        Warung Pumps began in <strong>[founding year]</strong> as a small pump repair workshop.
        Over the decades, we have grown into a trusted name in borewell, submersible, and openwell
        pump manufacturing. Our journey is grounded in rural expertise, hands-on innovation, and
...
<!-- Section 5: Trust Highlight -->
<section class="section highlight">
  <div class="container">
    <h2 class="text-center">Trusted by Thousands Across India</h2>
    <p style="max-width: 800px; margin: auto; text-align: center;">
      Whether it’s powering irrigation on farms in Uttar Pradesh, daily water use in rural homes,
      or meeting the demands of construction sites, Warung Pumps deliver with consistency. Our local
      network, fast service, and word-of-mouth growth define our success.
    </p>
  </div>
</section>

<!-- Section 6: Certifications & Dealer Map -->
<section class="section">
  <div class="container flex">
...
<section class="section text-center">
  <div class="container">
    <a href="contact.html" class="btn">Contact Us to Learn More</a>
  </div>
</section>

<!-- Sticky WhatsApp CTA -->
<a href="https://wa.me/918292397155?text=Hi%2C+I%27d+like+to+learn+more+about+Warung+Pumps" target="_blank" class="sticky-whatsapp">
  <span class="emoji">💬</span> Talk to Our Team
</a>
